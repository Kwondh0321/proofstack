...
export const MODEL_QUALIFICATION_REPORT_DEFINITION_DOMAIN =
  "proofstack.model-qualification-report.v1" as const;
export const MODEL_ASSURANCE_ASSESSMENT_DEFINITION_DOMAIN =
  "proofstack.model-assurance-assessment.v1" as const;
...
export function encodeHumanReviewProtocolDefinition(
  input: ScopedEvaluationDefinition<HumanReviewProtocolDefinition>,
): Uint8Array {
  const parsed = scopedDefinitionSchema(HumanReviewProtocolDefinitionSchema).parse(input);
  return encodeDefinition(
...
export function encodeModelQualificationReportDefinition(
  input: ScopedEvaluationDefinition<ModelQualificationReportDefinition>,
): Uint8Array {
  const parsed = scopedDefinitionSchema(ModelQualificationReportDefinitionSchema).parse(input);
  return encodeDefinition(
...
export function encodeModelAssuranceAssessmentDefinition(
  input: ScopedEvaluationDefinition<ModelAssuranceAssessmentDefinition>,
): Uint8Array {
  const parsed = scopedDefinitionSchema(ModelAssuranceAssessmentDefinitionSchema).parse(input);
  return encodeDefinition(
