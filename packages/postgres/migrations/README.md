...
API, identity, replay-worker, artifact-maintenance, publisher, and consumer roles, removes stale
ProofStack table, sequence, and function grants, and reapplies the audited least-privilege matrix.
