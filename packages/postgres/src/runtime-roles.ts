...
const PLATFORM_FUNCTIONS = [
  ...
  "public.proofstack_acknowledge_replay_cancellation_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, text)",
  "public.proofstack_append_replay_execution_observation(text, text, text, text, text, text, bigint, bigint, text, jsonb)",
  "public.proofstack_append_replay_execution_observation_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, jsonb)",
  "public.proofstack_append_replay_usage_observation(text, text, text, text, text, text, bigint, bigint, text, text, text, jsonb)",
  "public.proofstack_append_replay_usage_observation_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, text, text, jsonb)",
  "public.proofstack_apply_replay_recovery_epoch_to_attempt()",
  "public.proofstack_apply_replay_recovery_epoch_to_job()",
  "public.proofstack_assert_current_replay_recovery_epoch(bigint)",
  "public.proofstack_begin_replay_recovery()",
  "public.proofstack_claim_replay_job(text, text, text, text, text, text, text, text, text, bigint)",
  "public.proofstack_claim_replay_job_before_recovery_epoch(text, text, text, text, text, text, text, text, text, bigint)",
  "public.proofstack_complete_replay_job(text, text, text, text, text, text, bigint, bigint, text, text, jsonb, jsonb)",
  "public.proofstack_complete_replay_job_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, text, jsonb, jsonb)",
  ...
  "public.proofstack_create_replay_job_before_recovery_epoch(text, text, text, text, text, text, text)",
  "public.proofstack_current_replay_recovery_epoch()",
  ...
  "public.proofstack_guard_evaluation_lineage_cycle()",
  ...
  "public.proofstack_insert_release_policy(jsonb)",
  "public.proofstack_insert_release_policy_lifecycle(jsonb)",
  ...
  "public.proofstack_publish_release_policy(jsonb)",
  "public.proofstack_publish_release_policy_lifecycle(jsonb)",
  ...
  "public.proofstack_release_candidate_intent_status(text, text, jsonb, timestamp with time zone)",
  "public.proofstack_release_policy_intent_status(text, text, jsonb, timestamp with time zone)",
  "public.proofstack_release_policy_lifecycle_intent_status(text, text, jsonb, timestamp with time zone)",
  ...
  "public.proofstack_reconcile_replay_budget_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, text, jsonb)",
  "public.proofstack_reserve_replay_budget(text, text, text, text, text, text, bigint, bigint, text, jsonb, jsonb)",
  "public.proofstack_reserve_replay_budget_before_recovery_epoch(text, text, text, text, text, text, bigint, bigint, text, jsonb, jsonb)",
  ...
  "public.proofstack_verify_comparison_lineage_count()",
  "public.proofstack_verify_comparison_record_body()",
  "public.proofstack_verify_evaluation_lineage_count()",
  "public.proofstack_verify_evaluation_record_body()",
  "public.proofstack_verify_release_candidate_body()",
  "public.proofstack_verify_release_candidate_lineage()",
  "public.proofstack_verify_release_policy_graph()",
  "public.proofstack_verify_release_policy_lifecycle()",
...
const GRANTS: Record<RuntimeRoleKind, readonly string[]> = {
  api: [
    ...
    "GRANT SELECT ON TABLE public.proofstack_comparison_record_registry, public.proofstack_comparison_resource_bindings, public.proofstack_comparison_lineage, public.proofstack_comparison_records TO %ROLE%",
    "GRANT EXECUTE ON FUNCTION public.proofstack_publish_comparison_record(jsonb) TO %ROLE%",
    "GRANT SELECT ON TABLE public.proofstack_release_candidate_registry, public.proofstack_release_candidate_resources, public.proofstack_release_candidate_lineage, public.proofstack_release_candidates TO %ROLE%",
    "GRANT EXECUTE ON FUNCTION public.proofstack_publish_release_candidate(jsonb) TO %ROLE%",
    "GRANT EXECUTE ON FUNCTION public.proofstack_release_candidate_intent_status(text, text, jsonb, timestamp with time zone) TO %ROLE%",
...
async function assertSchemaCurrent(client: PoolClient): Promise<void> {
  ...
  const result = await client.query<{ readonly present: boolean }>(`
    ...
    FROM unnest(ARRAY[
      ...
      'public.proofstack_evaluation_source_reviewer_qualifications',
      ...
      'public.proofstack_comparison_record_registry',
      'public.proofstack_comparison_resource_bindings',
      'public.proofstack_comparison_lineage',
      'public.proofstack_comparison_records',
      ...
      'public.proofstack_release_candidate_registry',
      'public.proofstack_release_candidate_resources',
      'public.proofstack_release_candidate_lineage',
      'public.proofstack_release_candidates',
      'public.proofstack_release_policies',
      'public.proofstack_release_policy_lifecycle_events',
      'public.proofstack_release_policy_lineage',
      'public.proofstack_release_policy_registry',
      'public.proofstack_release_policy_resources',
      'public.proofstack_release_policy_rule_sources',
      'public.proofstack_release_policy_rules',
      'public.proofstack_release_policy_sources',
