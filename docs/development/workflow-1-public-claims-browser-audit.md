...
| Port ownership | The normal console port remains 3000. The audit used an alternate free port only because Grafana owned 3000. No service or guide requires a separately reserved comparison port, and the disposable acceptance runner owns random ports internally. Both audit services were stopped and their listeners were verified absent. | Accepted |
